		...
		const fetchTasks = async () => {
			try {
				...
				if (sortOption === "priority")
					url = "http://localhost:8080/tasks/sorted/priority";
				else if (sortOption === "dueDate")
					url = "http://localhost:8080/tasks/sorted/due-date";
				else if (sortOption === "priorityDueDate")
					url = "http://localhost:8080/tasks/sorted/priority-due-date";
				else if (sortOption === "completed")
					url = "http://localhost:8080/tasks/completed";
			...
			<div className='cat-container'>
				<div className='tasks-header'>
					<p className='quote-text1'>
						From To-Do to Done –{" "}
						<span className='highlight'>TenX Gets You There!</span>
					</p>
					<div className='header-actions'>
						<button
							className='new-task-btn1'
					...
					{loading ? (
						...
						tasks.map(task => (
							<div
								...
								<div>
									<span
										className={`task-stage-badge task-state-${
